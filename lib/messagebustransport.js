...
/**
 * MessageBusTransport defines an interface to be implemented by all concrete message bus transports.
 *
 ...
 * @public
*/
function MessageBusTransport(options) {
...
util.inherits(MessageBusTransport, EventEmitter);

module.exports = MessageBusTransport;

var transportModulesPath = path.join(path.dirname(module.filename), "./transportproviders");

MessageBusTransport.transports = utils.findModulesSync(transportModulesPath, MessageBusTransport);
 ...
 * @param {?Error} error - the error that occurred; null if there was no error
 * @memberof MessageBusTransport
 * @public
 * @alias MessageBusTransport.ConnectCallback
*/
 ...
 * @memberof MessageBusTransport
 * @public
 * @alias MessageBusTransport.DisconnectCallback
*/
 ...
 * @memberof MessageBusTransport
 * @public
 * @alias MessageBusTransport.PublishCallback
 */
 ...
 * @memberof MessageBusTransport
 * @public
 * @alias MessageBusTransport.ChannelCallback
*/
 ...
 *
 * @public
 * @alias MessageBusTransport.connected
*/
 ...
 *
 * @public
 * @alias MessageBusTransport.disconnected
*/
 ...
 *
 * @param {MessageBusTransport.ConnectCallback} [callback] - called when the connection is established.
 *
 * @fires MessageBusTransport.connected
 * @fires EventEmitter.error
 *
 * @public
 * @final
*/
MessageBusTransport.prototype.connect = function(callback) {
  var self = this;
 ...
 * @final
*/
MessageBusTransport.prototype.isConnected = function() {
 ...
 *
 * @param {MessageBusTransport.DisconnectCallback} [callback] - Optional callback called when
 * the provider has been disconnected or when an error occurred.
 *
 * @fires MessageBusTransport.event:disconnected
 * @public
 * @final
 * @see MessageBusTransport#isConnected
*/
MessageBusTransport.prototype.disconnect = function(callback) {
  var self = this;
 ...
 * @param {!MessageBusTransport.ChannelCallback} callback - Called when dispatchChannel is retrieved.
 *
 * @see ConsumeChannel
 * @public
 * @final
*/
MessageBusTransport.prototype.dispatchChannel = function(dispatchChannelName, callback) {
 ...
 * @final
*/
MessageBusTransport.prototype.consumeChannel = function(consumeChannelName,
                                                        dispatchChannelName,
                                                        callback) {
 ...
 *
*/
MessageBusTransport.prototype.publish = function(exchangeName, msg, routingKey, callback) {
 ...
 * @final
 */
MessageBusTransport.prototype.purge = function(queueName, callback) {
 ...
 * @final
*/
MessageBusTransport.prototype.consume = function(queueName, options, callback, successCallback) {
  assert.ok(util.isString(queueName), "Must provide a valid queue name.");
  ...
  this._doConsume(queueName, options, callback, function(err) {
    if (successCallback) {
      utils.callLater(successCallback, err);
    }
  });
};
 ...
 * @final
*/
MessageBusTransport.prototype.bind = function(consumeChannelName,
 ...
 * @final
*/
MessageBusTransport.prototype.unbind = function(consumeChannelName,
                                                dispatcherChannelName,
                                                bindingKey,
                                                callback) {
 ...
 * @final
*/
MessageBusTransport.prototype.options = function options() {
 ...
 * @private
*/
MessageBusTransport.prototype._doConnect = function(callback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doDisconnect = function(callback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doIsConnected = function() {
 ...
 * @private
*/
MessageBusTransport.prototype._doGetDispatchChannel = function(dispatchChannelName,
                                                               options,
                                                               callback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doGetConsumeChannel = function(consumeChannelName,
 ...
 * @private
*/
MessageBusTransport.prototype._doConsume = function(queueName,
                                                    options,
                                                    callback,
                                                    successCallback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doPublish = function(exchangeName, msg, callback) {
 ...
 * @private
 */
MessageBusTransport.prototype._doPurge = function(queueName, callback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doBind = function(consumerName,
                                                 publisherName,
                                                 bindingKey,
                                                 callback) {
 ...
 * @private
*/
MessageBusTransport.prototype._doUnbind = function(consumerName,
                                                   publisherName,
                                                   bindingKey,
                                                   callback) {
